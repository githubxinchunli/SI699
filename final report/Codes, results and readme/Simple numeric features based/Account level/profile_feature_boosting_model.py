...
text_clf_lr = GradientBoostingClassifier(n_estimators=100, learning_rate=1.0, max_depth=5, random_state=0)
...
plot_df['micro'] = micro
plot_df['macro'] = macro
plot_df.to_csv("profile_feature_boosting_result.csv",index=False)
