...
def bots_cleaning(df_genuine):
    ...
    df_genuine_new = df_genuine_new[['id','statuses_count', 'followers_count','friends_count', 'favourites_count', 'listed_count','verified']]
...
text_clf_lr = LogisticRegression(penalty="l1",random_state=0)
...
plot_df['micro'] = micro
plot_df['macro'] = macro
plot_df.to_csv("profile_feature_lr_result.csv",index=False)
